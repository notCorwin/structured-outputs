...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "flex flex-col overflow-hidden rounded-xl bg-card text-card-foreground shadow-sm ring-1 ring-foreground/10",
...
function CardHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("grid gap-1 px-4 [.border-b]:pb-4", className)}
      {...props}
    />
  );
}
